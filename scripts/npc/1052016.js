...
var cost = Array(800, 800, 1200, 1000);
var costBeginner = Array(80, 80, 120, 100);
var selectedMap = -1;
var job;
...
function action(mode, type, selection) {
        ...
        if (mode == 1)
                ...
                status--;
        if (status == 0) {
                cm.sendNext("How's it going? I drive the Regular Cab. If you want to go from town to town safely and fast, then ride our cab. We'll gladly take you to your destination for an affordable price.");
        } else if (status == 1) {
