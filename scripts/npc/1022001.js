...
var cost = Array(1000, 800, 800, 1200);
var costBeginner = Array(100, 80, 80, 120);
var selectedMap = -1;
var job;
...
function action(mode, type, selection) {
        ...
        if (mode == 1)
                ...
                status--;
        if (status == 0) {
                cm.sendNext("How's it going? I drive the Perion Taxi. If you want to go from town to town safely and fast, then ride our cab. We'll gladly take you to your destination for an affordable price.");
        } else if (status == 1) {
