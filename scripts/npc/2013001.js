	                        	...
	                        	// check for people on ropes
	                        	        ...
	                        	        if (totplayers == 5 /*|| debug*/) {
	                        	                ...
	                        	                if (debug) {
													...
													//cm.getPlayer().getClient().getSession().write(Packages.tools.MaplePacketCreator.triggerReactor(cm.getPlayer().getEventInstance().getMapInstance(920010500).getReactorByName("stone4"), 0));
													//cm.sendNext(combo);
													//clear(curMap,eim,cm);
													//cm.getPlayer().getEventInstance().getMapInstance(920010500).getReactorByName("stone4").setState(1);
	                        	                }
