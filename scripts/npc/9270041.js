...
function start() {
    cm.sendSimple("Hello there, I am Irene from Kerning City. I can assist you in getting to Singapore in no time. The only bad thing is that drops are eliminated in Singapore. How can I help you?\r\n#L0##bI would like to go to Singapore.#k#l");
}
