...
public class LoginServer implements Runnable, LoginServerMBean {
    ...
    private List<String> authip = new ArrayList<>();
    ...
    private static AuthServer authInst = new AuthServer();
            ...
            synchronized (lwi) {
                ...
                synchronized (wli) {
                    try {
                        ...
                        worlds = Integer.parseInt(prop.getProperty("world.numberOfWorlds"));
                        try {
    ...
    public void run() {
        ...
        PORT = Integer.parseInt(prop.getProperty("login.port"));
    ...
    void addAuthIp(String string) {
        this.authip.add(string);
    }

    public boolean getIPAuth(String toString) {
        return this.authip.contains(toString.split(":")[0]);
    }
}
