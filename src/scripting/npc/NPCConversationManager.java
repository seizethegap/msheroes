...
public class NPCConversationManager extends AbstractPlayerInteraction {
    ...
    public void makeRing(String partner, int ringId) {
        client.MapleRing.createRing(c, ringId, c.getPlayer().getId(), c.getPlayer().getName(), c.getChannelServer().getPlayerStorage().getCharacterByName(partner).getId(), partner);
    }
    ...
    public static boolean makeRing(MapleClient mc, String partner, int ringId) {
        ...
        int[] ret = client.MapleRing.createRing(mc, ringId, mc.getPlayer().getId(), mc.getPlayer().getName(), partnerId, partner);
